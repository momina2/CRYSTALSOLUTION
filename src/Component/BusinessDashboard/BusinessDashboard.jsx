...
// // API Endpoints
// const MAIN_API_URL = "https://crystalsolutions.pk/api/CSDashboard.php";
// const DAILY_COLLECTION_API_URL =
//   "https://crystalsolutions.pk/api/DailyMemberCollection.php";
...
//         onClick={() =>
//           window.open(
//             window.location.origin + stat.link, // dynamic link
//             "_blank",
//           )
//         }
//         className={`flex justify-between items-center p-2 cursor-pointer ${
//           index < stats.length - 1 ? "border-b border-gray-100" : ""
//         } transition duration-150 hover:bg-blue-50 hover:scale-[1.01]`}
//       >
//         <p className="text-xs font-medium text-gray-500">{stat.title}</p>
...
//       value: data.TotalBal,
//       isDark: true,
//       link: "/crystalsol/TotalBalance",
//     },
//     {
//       title: "Total Arrear",
//       value: data.TotalArrear,
//       link: "/crystalsol/TotalArrear",
//     },
//     {
//       title: "Total Collection",
//       value: data.TotalCol,
//       link: "/crystalsol/TotalCollection",
//     },
//     {
//       title: "Total Expense",
//       value: data.TotalExp,
//       link: "/crystalsol/TotalExpense",
//     },
//     {
//       title: "Profit",
//       value: data.TotalProfit,
//       isNegative: data.TotalProfit?.toString().includes("-"),
//       link: "/crystalsol/ProfitReport",
//     },
//   ];
...
//       link: "/crystalsol/TotalMembers",
//     },
//     {
//       title: "Today Members",
//       value: data.TodayMembers,
//       link: "/crystalsol/TodayMembers",
//     },
//     {
//       title: "Month Member",
//       value: data.MonthMembers,
//       link: "/crystalsol/MonthlyMembers",
//     },
//     {
//       title: "Month Leave Member",
//       value: data.MonthLeaveMember,
//       link: "/crystalsol/LeaveMembers",
//     },
//   ];
...
//       title: "30 Days",
//       value: data.PayDay30,
//       link: "/crystalsol/FeeAging30",
//     },
//     {
//       title: "60 Days",
//       value: data.PayDay60,
//       link: "/crystalsol/FeeAging60",
//     },
//     {
//       title: "90 Days",
//       value: data.PayDay90,
//       link: "/crystalsol/FeeAging90",
//     },
//     {
//       title: "90+ Days",
//       value: data.PayDay90Above,
//       link: "/crystalsol/FeeAging90Plus",
//     },
//   ];
...
//     {
//       title: "Monthly Bill",
//       value: data["Month-Bil"],
//       link: "/crystalsol/MonthlyBill",
//     },
//     {
//       title: "Monthly Call",
//       value: data["Month-Cal"],
//       link: "/crystalsol/MonthlyCall",
//     },
//     {
//       title: "Monthly Reminder",
//       value: data["Month-Rem"],
//       link: "/crystalsol/MonthlyReminder",
//     },
//     {
//       title: "Today Bill",
//       value: data["Today-Bil"],
//       link: "/crystalsol/TodayBill",
//     },
//     {
//       title: "Today Call",
//       value: data["Today-Cal"],
//       link: "/crystalsol/TodayCall",
//     },
//     {
//       title: "Today Reminder",
//       value: data["Today-Rem"],
//       link: "/crystalsol/TodayReminder",
//     },
//   ];
...
const VerticalStatsCard = ({ stats, cardTitle = null }) => (
  <div className="p-2 rounded-xl shadow-xl bg-white border border-gray-100 flex flex-col w-full h-full min-h-[300px]">
    {cardTitle && (
      <>
        <h3 className="text-base font-bold text-gray-800 mb-1 px-2">
          {cardTitle}
    ...
    {stats.map((stat, index) => (
      <div
        ...
        onClick={() =>
          stat.link &&
          window.open(window.location.origin + stat.link, "_blank")
        }
        className={`flex justify-between items-center p-2 ${
          stat.link ? "cursor-pointer hover:bg-blue-50 hover:scale-[1.01]" : ""
        } ${
          index < stats.length - 1 ? "border-b border-gray-100" : ""
      ...
      <div className="flex-grow overflow-y-auto max-h-[350px]">
        {detail.length > 0 ? (
          detail.map((item, index) => (
            <div
              key={item["Trn#"] + index}
              className="flex justify-between items-center p-1 transition duration-150 hover:bg-gray-50"
            >
              <p className="text-xs text-gray-800 font-medium w-2/3 truncate">
                {item.Member}
              </p>
...
const BusinessDashboard = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        formData.append("code", "CRYSTALSOFT");
        formData.append("FLocCod", "001");
        formData.append("FYerDsc", "2025-2026");
  ...
  useEffect(() => {
    const fetchDailyCollectionData = async () => {
      try {
        ...
        setDailyCollectionError("Couldn't fetch daily collection.");
      } finally {
        setDailyCollectionLoading(false);
      }
    };
  ...
  const membershipStats = [
    ...
    {
      title: "Current Year Members",
      value: data.CurrentYearMembers,
      link: "/crystalsol/CurrentYearMembers",
    },

    {
      title: "Current Month Members",
      value: data.CurrentMonthMembers,
      link: "/crystalsol/CurrentMonthMembers",
    },

    {
      title: "Last Month Members",
      value: data.LastMonthMembers,
      link: "/crystalsol/LastMonthMembers",
    },

    {
      title: "Leaved Members",
      value: data.LeavedMembers,
      link: "/crystalsol/LeavedMembers",
    },
