...
const REPORT_NAME = "Outstanding Customers";
...
export default function AmericanOutstanding() {
    ...
    const fetchData = async () => {
      try {
        ...
        const res = await axios.post(
          "https://crystalsolutions.pk/api/AmericanOutstandingCustomers.php",
          form,
          { timeout: 20000 }
        );
 ...
 const exportPDFHandler = () => {
  ...
  const pdfColumns = columnsConfig.filter(
    (c) =>
      !["scrollSpacer", "ledgerBtn", "progressBtn"].includes(c.key)
  );
