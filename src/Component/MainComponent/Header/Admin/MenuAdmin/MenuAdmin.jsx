            ...
            >
              <div className="row">
                <div className="col-sm-8">
                  ...
                  <div className="row">
                    <div className="col-sm-2 label-field">URL:</div>
                    <div className="col-sm-10">
                      <Form.Control
                        type="text"
                        id="inputform4"
                        ...
                        onKeyDown={(e) => {
                          ...
                          if (e.key === "Enter") {
                            ...
                            if (
                              ...
                              // Add '/' at the start of the input
                              const newValue = "/" + currentValue;

                              // Update the state with the new value
                              setFormData((prevState) => ({
                                ...prevState,
                                inputform4: newValue, // Update the specific field
                              }));
                            }

                            handleEnterKeyPress(inputform5ref, e); // Call your existing function
                          }
                        }}
                      />
                    </div>
