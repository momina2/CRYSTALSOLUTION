...
const CustomDropdownforcategory = forwardRef(
  (
    {
      value,
      onChange,
    ...
    const handleSaveReference = async (customOption) => {
      ...
      try {
        ...
        formData.append(postfouth, "0");
        formData.append(postfifth, "0");
        formData.append(postsixth, "0");
        formData.append(postseventh, user.tusrid);
        formData.append(posteight, organisation.code);
...
CustomDropdownforcategory.propTypes = {
  value: PropTypes.any,
...
export default CustomDropdownforcategory;
