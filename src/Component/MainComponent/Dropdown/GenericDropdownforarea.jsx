...
const GenericDropdownforarea = forwardRef(
  (
    {
      value,
      onChange,
    ...
    const { getcolor, fontcolor, apiLinks } = useTheme();
    ...
    const handleSaveReference = async (customOption) => {
      console.log("additionalData", additionalData.FCtyCod);

      try {
        const formData = new FormData();
        formData.append("FAreCod", "999");
        formData.append("FAreDsc", customOption.label);
        formData.append("FAreSts", "A");
        formData.append("FAreCty", additionalData.FCtyCod);
        formData.append("FUsrId", user.tusrid);
        formData.append("code", organisation.code);
        const response = await axios.post(
          `${apiLinks}/SaveArea.php`,
          formData,
          {
...
GenericDropdownforarea.propTypes = {
  value: PropTypes.any,
...
export default GenericDropdownforarea;
