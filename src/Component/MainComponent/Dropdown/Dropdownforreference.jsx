...
const CustomDropdownforreference = forwardRef(
  (
    {
      value,
      onChange,
    ...
    const handleSaveReference = async (customOption) => {
      ...
      try {
        ...
        formData.append(postsixth, user.tusrid);
        formData.append(postseventh, organisation.code);
...
CustomDropdownforreference.propTypes = {
  value: PropTypes.any,
...
export default CustomDropdownforreference;
