...
const CustomDropdownwithlocation = forwardRef(
  (
    {
      value,
      onChange,
    ...
    const { getcolor, fontcolor, getLocationNumber } = useTheme();
...
CustomDropdownwithlocation.propTypes = {
  value: PropTypes.any,
...
export default CustomDropdownwithlocation;
