...
export default function SparePartProfitSummary() {
  ...
  const exportPDFHandler = () => {
    ...
    const headers = ["Code", "Technician", "Jobs", "Parts", "Profit"];
    ...
    const handlePagination = () => {
      ...
      while (currentPageIndex * rowsPerPage < rows.length) {
        ...
        addTitle(
          `Spare Parts Profit Summery From: ${fromInputDate} To: ${toInputDate}`,
          "",
          "",
          pageNumber,
          startY,
    ...
    // Save the PDF files
    doc.save(
      `SparePartsProfitSummary Form ${fromInputDate} To ${toInputDate}.pdf`
    );
  };
  ///////////////////////////// DOWNLOAD PDF CODE ////////////////////////////////////////////////////////////
  ...
  const handleDownloadCSV = async () => {
    ...
    worksheet.mergeCells(
      `A${companyRow.number}:${String.fromCharCode(60 + numColumns - 1)}${
        companyRow.number
      }`
    );
    ...
    const storeListRow = worksheet.addRow([
      `Spare Parts Profit Summary From ${fromInputDate} To ${toInputDate}`,
    ]);
    ...
    worksheet.mergeCells(
      `A${storeListRow.number}:${String.fromCharCode(60 + numColumns - 1)}${
        storeListRow.number
      }`
    );
    ...
    saveAs(
      blob,
      `SparePartsProfitSummary From ${fromInputDate} To ${toInputDate}.xlsx`
    );
  };
  ///////////////////////////// DOWNLOAD PDF EXCEL ///////////////////////////////////////////////////////////
