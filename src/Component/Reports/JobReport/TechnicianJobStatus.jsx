...
export default function TechnicianJobStatusReport() {
  ...
  const exportPDFHandler = () => {
    ...
    // Save the PDF files
    doc.save(
      `TechnicianJobStatusReport Form ${fromInputDate} To ${toInputDate}.pdf`
    );
  };
  ///////////////////////////// DOWNLOAD PDF CODE ////////////////////////////////////////////////////////////
  ...
  const handleDownloadCSV = async () => {
    ...
    worksheet.mergeCells(
      `A${companyRow.number}:${String.fromCharCode(63 + numColumns - 1)}${
        companyRow.number
      }`
    );
    ...
    worksheet.mergeCells(
      `A${storeListRow.number}:${String.fromCharCode(63 + numColumns - 1)}${
        storeListRow.number
      }`
    );
    ...
    saveAs(
      blob,
      `TechnicianJobStatusReport From ${fromInputDate} To ${toInputDate}.xlsx`
    );
  };
  ///////////////////////////// DOWNLOAD PDF EXCEL ///////////////////////////////////////////////////////////
