...
export default function ReferenceReceivableReport() {
  ...
  const {
    ...
    getyeardescription,
    getfromdate,
    gettodate,getnavbarbackgroundcolor,
    getdatafontsize,
    getfontstyle,
  } = useTheme();
  ...
  const exportPDFHandler = () => {
    ...
    const handlePagination = () => {
      ...
      while (currentPageIndex * rowsPerPage < rows.length) {
        ...
        addTitle(
          `Reference Receivable Report From: ${fromInputDate} To: ${toInputDate}`,
          "",
          "",
          pageNumber,
          startY,
    ...
    // Save the PDF files
    doc.save(
      `ReferenceReceivableReport Form ${fromInputDate} To ${toInputDate}.pdf`
    );
  };
  ///////////////////////////// DOWNLOAD PDF CODE ////////////////////////////////////////////////////////////
  ...
  const handleDownloadCSV = async () => {
    ...
    saveAs(
      blob,
      `ReferenceReceivableReport From ${fromInputDate} To ${toInputDate}.xlsx`
    );
  };
  ///////////////////////////// DOWNLOAD PDF EXCEL ///////////////////////////////////////////////////////////
