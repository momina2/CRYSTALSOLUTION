...
export default function CategoryMonthlyJobComparison() {
  ...
  useEffect(() => {
    ...
    if (
      ...
      (input1Reftype && input1Reftype.current)
    ) {
  ...
  const exportPDFHandler = () => {
    ...
    const columnWidths = [
      15, 50, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16,
    ];
    ...
    const handlePagination = () => {
      ...
      while (currentPageIndex * rowsPerPage < rows.length) {
        ...
        addTitle(
          `Category Monthly Job Comparison Report`,
          "",
          "",
          pageNumber,
          startY,
  ...
  const handleDownloadCSV = async () => {
    ...
    saveAs(
      blob,
      `CategoryMonthlyJobComparisonReport As on ${currentdate}.xlsx`
    );
  };
  ///////////////////////////// DOWNLOAD PDF EXCEL ///////////////////////////////////////////////////////////
