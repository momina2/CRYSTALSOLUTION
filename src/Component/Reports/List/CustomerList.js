...
export default function CustomerListAmerican() {
  ...
  const handleSorting = async (col) => {
    ...
    const parseValue = (value) => {
      return value
        ? parseFloat(value.toString().replace(/,/g, "")) || value
        : ""; // Remove commas, parse numbers, fallback to original value
    };
                  ...
                  >
                    ...
                    >
                      ...
                      <i
                        ...
                        style={{
                          transform: isAscendingcode
                            ? "rotate(0deg)"
                            : "rotate(180deg)", // 180deg for better visual
