...
// // =====================================
// const REPORT_CONFIG = {
//   API_LINK: "/StoreList.php",
//   REPORT_NAME: "Store List Report",
//   TABLE: {
//     HEADERS: ["Code", "Description", "Status", "Abb", "Stk", "Ins ID", "Ins Date", "Upd ID", "Upd Date"],
//     KEYS: ["Code", "Description", "Status", "Abb", "Stk", "Ins ID", "Ins Date", "Upd ID", "Upd Date"],
//     UI_WIDTHS: {
//       col001: "60px",
//       col002: "80px",
//       col003: "250px",
...
//     },
//     PDF_WIDTHS: [14, 20, 70, 10, 11, 20, 11, 11, 11],
//     EXCEL_WIDTHS: [8, 12, 35, 7, 8, 12, 12, 12, 12],
//     ALIGNMENTS: ["left", "left", "left", "center", "left", "right", "center", "left", "right"],
//     PDF_ALIGNMENTS: ["left", "left", "left", "right", "right", "right", "center", "left", "right"],
//     TOTAL_COLUMN_INDEX: 0,
//   },
// };
...
//         const rowTopY =
//           startY + (rowRelativeIndex + 1) * rowHeight + headerHeight;
...
//           if (isTotalRow) {
//             doc.setLineWidth(0.3);
//             doc.line(currentX, rowTopY, currentX + cellWidth, rowTopY);
//             doc.line(
//               currentX,
//               rowTopY + 0.5,
//               currentX + cellWidth,
//               rowTopY + 0.5
//             );
//             doc.line(currentX, rowBottomY, currentX + cellWidth, rowBottomY);
//             doc.line(
//               currentX,
//               rowBottomY - 0.5,
//               currentX + cellWidth,
...
//         // Table Body
//         addTableRows(tableStartX, headerY, startIndex, endIndex);
...
//     const worksheet = workbook.addWorksheet(REPORT_CONFIG.REPORT_NAME);
...
//   // FIX: Updated hotkey for "Select" button to call the renamed function
//   useHotkeys("alt+s", fetchStoreListReport, {
//     preventDefault: true,
