...
export default function MobileLedger() {
  ...
  const exportPDFHandler = () => {
    ...
    const handlePagination = () => {
      ...
      while (currentPageIndex * rowsPerPage < rows.length) {
        ...
        addTitle(
          `Mobile Ledger Report From: ${fromInputDate} To: ${toInputDate}`,
          "",
          "",
          pageNumber,
          startY,
  ...
  const handleDownloadCSV = async () => {
    ...
    const totalRow = worksheet.addRow(["", "", "Total", String(totalDebit)]);
    ...
    saveAs(
      blob,
      `MobileLedgerReport From ${fromInputDate} To ${toInputDate}.xlsx`
    );
  };
