...
export default function DailySaleReportPOS() {
  ...
  const exportPDFHandler = () => {
    ...
    const columnWidths = [
      10, 15, 40, 15, 12, 20, 30, 30, 20, 20, 20, 20, 20, 20,
    ];
  ...
  const handleDownloadCSV = async () => {
    ...
    // Set column widths
    [7, 23, 30, 8, 8, 10, 20, 20, 12, 15, 10, 15, 15, 15].forEach(
      (width, index) => {
    ...
    saveAs(
      blob,
      `DailySaleReportPos From ${fromInputDate} To ${toInputDate}.xlsx`
    );
  };
  ...
  return (
    <>
      ...
      <div style={contentStyle}>
        ...
        >
          <NavComponent textdata="Daily Sale Report (Pos)" />
