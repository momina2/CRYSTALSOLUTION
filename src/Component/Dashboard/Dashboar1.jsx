...
export default function SalesDasboard() {
  ...
  const { isSidebarVisible, getcolor, fontcolor, apiLinks } = useTheme();
    ...
    <>
      <div className="row Countair_styling" style={contentStyle}>
              ...
              <table className="first_column_table ">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="col2"></td>
                    <td class="col3" style={{ fontWeight: "bold" }}>
                      {DailyDashboard.Margin}
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            <div className="second_section_first_column">
              ...
              <div className="col-md-6 inner_section_first_column1">
                <div className="row leable_row_styling">
                  <div
                    className="col-md-6 lable_left_section"
                    style={{ background: "#2196F3", padding: "0px" }}
                  >
                    C&B
                  </div>
                ...
                <div className="row leable_row_styling">
                  <div
                    className="col-md-6 lable_left_section"
                    style={{ background: "#4AB052", padding: "0px" }}
                  >
                    Receivable
                  </div>
                  <div className="col-md-6 lable_right_section">
                ...
                <div className="row leable_row_styling">
                  <div
                    className="col-md-6 lable_left_section"
                    style={{ background: "#FE5353", padding: "0px" }}
                  >
                    Payable
                  </div>
                  <div className="col-md-6 lable_right_section">
                ...
                <div className="row leable_row_styling">
                  <div
                    className="col-md-6 lable_left_section"
                    style={{ background: "#673BB7", padding: "0px" }}
                  >
                    Stock
                  </div>
                  <div className="col-md-6 lable_right_section">{0}</div>
                </div>
              </div>
            </div>
            ...
            <div className="Diamond_section">
                ...
                >
                  ...
                  >
                    <div style={{ lineHeight: "14px" }}>
                      {DailyDashboard["Day-One"]}
                      <br />
                      {DailyDashboard["Date-One"]}
                    </div>
                  </div>
                </div>
                <div
                  className="Diamond_sale"
                  style={{
                    padding: "0px",
                    width: "20%",
                    height: "65%",
              ...
              >
                ...
                >
                  ...
                  >
                    <div style={{ lineHeight: "14px" }}>
                      {DailyDashboard["Day-Two"]}
                      <br />
                      {DailyDashboard["Date-Two"]}
                    </div>
                  </div>
                </div>
                <div
              ...
              >
                ...
                >
                  ...
                  >
                    <div style={{ lineHeight: "14px" }}>
                      {DailyDashboard["Day-Three"]}
                      <br />
                      {DailyDashboard["Date-Three"]}
                    </div>
                  </div>
                </div>
                <div
              ...
              >
                ...
                >
                  ...
                  >
                    <div style={{ lineHeight: "14px" }}>
                      {DailyDashboard["Day-Four"]}
                      <br />
                      {DailyDashboard["Date-Four"]}
                    </div>
                  </div>
                </div>
                <div
        ...
        <div style={{ height: "100%", width: "70%", padding: "0px" }}>
          ...
          <div className="row Row_styling">
            <div
              className="second_container_card"
              style={{
                display: "flex",
                      ...
                      {isLoading ? (
                        ...
                        <>
                          ...
                          {Array.from({
                            length: Math.max(
                              0,
                              27 - CompanySaleComparison.length
                            ),
                          }).map((_, rowIndex) => (
                            <tr
                              key={`blank-${rowIndex}`}
