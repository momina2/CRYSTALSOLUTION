...
export default function NASIRTRADERSCashReport() {
  ...
  async function exportCSV({
    ...
    totalRowData[0] = rows.length.toString(); // total rows
    totalRowData[headers.length - 1] = Number(totalCollection || 0); // numeric value
  ...
  const handleCSV = () => {
    exportCSV({
      ...
      columnsConfig,
      totalCollection: apiTotalBalance, // ✅ REQUIRED
